...
function mytheme_custom_styles() {
    ...
    wp_enqueue_style( 'custom-style1',  'http://fonts.googleapis.com/css?family=Open+Sans:400%7CMontserrat:600%2C400');
     wp_enqueue_style( 'custom-style12', get_template_directory_uri() . '/assets/css/bootstrap.min.css');
	wp_enqueue_style( 'custom-style2', get_template_directory_uri() . '/assets/fonts/css/all.min.css');
	wp_enqueue_style( 'custom-style3', get_template_directory_uri() . '/assets/css/navigation.css');
	wp_enqueue_style( 'custom-style4', get_template_directory_uri() . '/assets/css/stylesheet.css');
	wp_enqueue_style( 'custom-style5', get_template_directory_uri() . '/assets/css/responsive.css');
    wp_enqueue_style( 'custom-style6', get_template_directory_uri() . '/assets/css/farmite.min.css');
    wp_enqueue_style('custom-style7', get_template_directory_uri() . '/assets/css/jquery.bs4-scrolling-tabs.css');
...
wp_enqueue_script( 'myscript1', get_template_directory_uri() . '/assets/js/plugins.js', array(), false, true );
wp_enqueue_script( 'myscript2', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), false, true );
wp_enqueue_script( 'myscript3', get_template_directory_uri() . '/assets/js/main.js', array(), false, true );
wp_enqueue_script( 'myscript4', get_template_directory_uri() . '/assets/js/navigation.js', array(), false, true );	
wp_enqueue_script( 'myscript5', get_template_directory_uri() . '/assets/js/navigation.fixed.min.js', array(), false, true );	
wp_enqueue_script( 'myscript6', get_template_directory_uri() . '/assets/js/jquery.bs4-scrolling-tabs.js', array(), false, true );	
wp_enqueue_script( 'myscript7', get_template_directory_uri() . '/assets/js/st-demo.js', array(), false, true );  
...
function add_extra_class_to_menu_items($classes, $item, $args, $depth) {
    ...
    if (in_array('menu-item-has-children', $classes)) {
        $classes[] = 'menu-dropdown'; // Add your custom class
    }
    return $classes;
}
...
function add_extra_column_after_title($columns) {
    ...
    foreach ($columns as $key => $value) {
        ...
        if ($key == 'title') {
            $new_columns['custom_taxonomy'] = __('Product Category'); // Add new column after the title
        }
    }
    
    return $new_columns;
}
add_filter('manage_our-product_posts_columns', 'add_extra_column_after_title');


// Populate the custom column
function populate_extra_column_after_title($column, $post_id) {
    if ($column === 'custom_taxonomy') {
        $terms = get_the_terms($post_id, 'our-product-catrgoryes');
...
add_action('manage_our-product_posts_custom_column', 'populate_extra_column_after_title', 10, 2);
...
// Custom CSS for featured image column in galleryes
